...
The coefficients of the logistic regression are calculates using the package $\textbf{glmnet}$ `r Cite(bib, 'glmnet')`.
...
If $\alpha$ = 0 then we have Ridge regression. If $\alpha$ = 1 then we have Lasso regression.
